    ...
    <div className=''>
      ...
      <div className='bg-transparent p-4'>
        {cartItems.length === 0 ? (
          ...
          <div
            className={`${
              resetAnimation ? 'rotate-in-2-fwd-cw' : 'hidden'
            } lg:w-96 h-96 pl-5 mt-8 overflow-y-scroll scrollbar-container rounded-md m-auto border-2 border-yellow-700 flex flex-col justify-start items-start`}
          >
            ...
            {cartItems.map((item, i) => (
              ...
              >
                ...
                <div className='flex flex-col justify-start ml-4'>
                  ...
                  <div className='flex gap-2 items-center mt-3 px-1'>
                    <button
                      onClick={() => {
                    ...
                    <span className='text-xl font-semibold text-yellow-200 font-sans'>
                      {item.quantity}
                    </span>
                    <button
                      onClick={() => {
